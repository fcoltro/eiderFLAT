use eiderflat_document::{Color, Document, EntityKind};
...
mod tests {
    ...
    fn stroke_attribute_sets_entity_color() {
        ...
        assert_eq!(colors[0], eiderflat_document::Color::Rgb(255, 0, 0));
        assert_eq!(colors[1], eiderflat_document::Color::Rgb(0, 255, 0));
    }
